const programmingLanguages = [
  ...
  // Question 7: Print the names of languages that have "Script" in their 
...
// Question 5: Print the languages that are both functional and object-oriented.
   ...
   console.log(" \nPrint the languages that are both functional and object-oriented.");
  ...
  console.log(" \nPrint the names of the creators of the languages");

   programmingLanguages.map(data=>console.log(data.creator));
    ...
    programmingLanguages.filter(data=> data.name.includes('Script')).forEach(p=>console.log(p.name));
